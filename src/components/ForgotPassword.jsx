    ...
    const submitForgotPassword = (event) => {
        ...
        .then((response) => {
            ...
            if (response.status == 200) {
                ...
                submitMessage.innerHTML = t("auth.errors.confirmationFailed");
        ...
        .catch((error) => {
            console.log(error)
            submitMessage.innerHTML = t("auth.errors.confirmationFailedEmail");
            submitMessage.classList.remove("hidden");
        });
    };
    ...
    >
      {t("auth.languageToggle")}
            ...
            <form id="login-form" onSubmit={submitForgotPassword}>
                <div id="login-form-title">{t("auth.forgotPassword")}</div>
                
                <div id="email-field" className="form-field">
                    <div className="form-field-title">
    <span className="required-star">*</span>{t("auth.enterHerdEmail")}
</div>
