...
export default function PostAudioPlayer({ src, compact = false, disabled = false }) {
  ...
  return (
    <div className={`postCardAudio${compact ? " postCardAudio--compact" : ""}`}>
      ...
      {disabled ? (
        <div
          ref={trackRef}
          className="disabledPostCardAudio__track"
          onClick={onSeek}
          role="presentation"
        >
        </div>
