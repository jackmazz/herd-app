...
export const ResetPasswordModal = ({
    ...
    return (
        <div className="reset-password-modal" role="dialog" aria-modal="true" aria-labelledby="reset-modal-title">
            <div className="reset-password-modal__menu" ref={modalRef}>
                <button
                    className="reset-password-modal__close-button-wrapper"
                    onClick={(event) => {
                        cleanupState();
                        onClose(event);
                    }}
                ...
                <div className="reset-password-modal__message" id="reset-modal-title">
...
const NewPasswordField = ({
    ...
    useEffect(() => {   
        ...
        if (value.length === 0) {
            setValid(false);
            setErrorMessage(t("settings.resetPasswordModal.errors.newPasswordRequired"));
            return;
        }
        ...
        if (value.length < valueMinLength) {
            setValid(false);
            setErrorMessage(
    t("settings.resetPasswordModal.errors.passwordRules", { count: valueMinLength })
);
            return;
        }
        ...
        if (value.length > valueMaxLength) {
            setValid(false);
            setErrorMessage(
    t("settings.resetPasswordModal.errors.passwordTooLong", { count: valueMaxLength })
);
            return;
        }
    ...
    t("settings.resetPasswordModal.errors.passwordRules", { count: valueMinLength })
        ...
        if (value.length === valueMaxLength) {
            setValid(true);
            setErrorMessage(t("settings.resetPasswordModal.errors.maxReached"));
            return;
        }
...
const ConfirmPasswordField = ({
    ...
    useEffect(() => {        
        ...
        if (value.length === 0) {
            setValid(false);
            setErrorMessage(t("settings.resetPasswordModal.errors.confirmPasswordRequired"));
            return;
        }
        ...
        if (value !== confirmationKey) {
            setValid(false);
            setErrorMessage(t("settings.resetPasswordModal.errors.passwordMismatch"));
            return;
        }
...
const ResetTokenField = ({
    ...
    useEffect(() => {        
        ...
        if (value.length === 0) {
            setValid(false);
            setErrorMessage(t("settings.resetPasswordModal.errors.resetCodeRequired"));
            return;
        }
        ...
        if (value.length > valueMaxLength) {
            setValid(false);
           setErrorMessage(
    t("settings.resetPasswordModal.errors.resetCodeTooLong", { count: valueMaxLength })
);
            return;
        }
