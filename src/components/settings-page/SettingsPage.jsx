...
import { ColorModeDropDown } from "components/settings-page/dropdowns/ColorModeDropDown.jsx";

import { PrivateAccountSwitch } from "components/settings-page/switches/PrivateAccountSwitch.jsx";
import { ReadingModeSwitch } from "components/settings-page/switches/ReadingModeSwitch.jsx";
...
export const SettingsPage = () => {
    ...
    const [isReadingModeOpen, setIsReadingModeOpen] = useState(true);
    ...
    useEffect(() => {
        ...
        const loadCurrentUser = async () => {
            try {            
                ...
                const statusData = attributesData.status ?? Config.STATUS_NEUTRAL;
                ...
                const publicFollowData = attributesData.publicFollowNotifications ?? true;
                const commentNotifData = attributesData.commentNotifications ?? true;
                const replyNotifData = attributesData.replyNotifications ?? true;
                const publicCommunityNotifData = attributesData.publicCommunityNotifications ?? true;
                const emailNotificationsData = attributesData.emailNotifications ?? false;
                const readingModeData = attributesData.readingMode ?? false;
                ...
                setCurrentUser({
                    ...
                    attributes: {
                        ...
                        publicFollowNotifications: publicFollowData,
                        commentNotifications: commentNotifData,
                        replyNotifications: replyNotifData,
                        publicCommunityNotifications: publicCommunityNotifData,
                        emailNotifications: emailNotificationsData,
                        readingMode: readingModeData,
                    },
                });
  ...
  {t("settings.loading")}
    ...
    return (
        <div className="settings-page">            
            ...
            <div className="settings-section">
                <div className="settings-section__title">{t("settings.accessibility")}</div>
                <div className="settings-section__content">
                    <div className="settings-section__content-row">
                        <div className="settings-section__content-column__span">
                            <ColorModeDropDown
