...
export const SearchPage = () => {
    ...
    const onJoin = (communityId) => {    
        ...
        .catch((error) => {
            showAlert("Failed to join community, check your internet connection and try again.");
        });
    };
    ...
    const onRequest = (communityId) => {
        ...
        .then((community) => {
            ...
            .catch((error) => {
                showAlert("Failed to request to join community, check your internet connection and try again.");
            });
        });
    };
    ...
    const onCancelRequest = (communityId) => {    
        ...
        .then((community) => {
            ...
            .catch((error) => {
                showAlert("Failed to cancel request to join community, check your internet connection and try again.");
            });
        });
    };
    ...
    useEffect(() => {    
        ...
        const searchCommunities = async (currentUser) => {
            try {        
                ...
                showAlert("Failed to search communities, check your internet connection and try again.", true);
                return false;
            }
        };
        ...
        const fetchJoinedCommunityIds = async (currentUser) => {
            ...
            // show an alert
                ...
                showAlert("Failed to retrieve joined communities, check your internet connection and try again.", true);
                return false;
            }
        };
        ...
        const load = async () => {
            ...
            // show an alert
                ...
                showAlert("Failed to download profile, check your internet connection and try again.", true);
            }
        };
        load();
        ...
        return (
            <>
                <div className="settings-page settings-page__loading">
                    <p className="settings-page__loading-text">Loading...</p>
                </div>
                <AlertModal
        ...
        <div className="search-page">
            <div className="search-page__title">
                {!searchValue ? (
                    ...
                    `Showing ${communityList.length} results for '${searchValue}'`
                )}
            </div>
